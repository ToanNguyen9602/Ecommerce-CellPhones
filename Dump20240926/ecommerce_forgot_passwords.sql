...
CREATE TABLE `forgot_passwords` (
  ...
  `otp_expiration_date` datetime(6) DEFAULT NULL,
  `otp_token` varchar(255) DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKrear8vh2jm2wp0qrs136gabsn` (`user_id`),
  CONSTRAINT `FK2vrccrbdatq93db8iy3a01p2e` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
